...
<div class="right">
    <div class="search-box">
        <form method="post" action="<?php echo Url::toRoute('demo/aa') ?>">
            <ul>
                <li>
                    <span>请输入字段名称：</span>
                    <input class="filed-name" name="filed-name" type="text">
                </li>
                <li>
                    <span>请输入字段默认值：</span>
                    <input class="filed-default" name="filed-default" type="text">
                </li>
                <li>
                    <span>请选择字段类型：</span>
                ...
                <li>
                    <span>请填写字段选项：</span>
                    <input type="text" value="0" class="filed-name" placeholder="选项1">
                    <input type="text" value="1" class="filed-name" placeholder="选项2">
                </li>
                <li>
                    <span>是否必填：</span>
                    <input type="checkbox" name="filed_where" value="1">必填
                </li>
                <li>
                    <span>请选择验证规则：</span>
                ...
                <li>
                    <span>请选择填写长度范围：</span>
                    <input class="length" name="filed_small" type="text" value="" placeholder="请输入最小长度">
                    ~
                    <input class="length" name="filed_big" type="text" value="" placeholder="请输入最大长度">
                </li>
                <li>
